...
int main(int argc, char *argv[]){
	...
	for(t=0; t<freq*duration; ++t){
		...
		note(t, 1.0f, 2.0f, i_mi, i0,  rho, dt, Fmax, freq);
		note(t, 2.0f, 3.0f, i_mi, i0,  rho, dt, Fmax, freq);
		note(t, 3.0f, 4.0f, i_mi, i0,  rho, dt, Fmax, freq);
		note(t, 4.0f, 5.0f, i_mi, i0,  rho, dt, Fmax, freq);
		note(t, 5.0f, 6.0f, i_mi, i0,  rho, dt, Fmax, freq);
		note(t, 6.0f, 7.0f, i_mi, i0,  rho, dt, Fmax, freq);
		note(t, 7.0f, 8.0f, i_mi, i0,  rho, dt, Fmax, freq);
		note(t, 8.0f, 10.0f, i_mi, i0, rho, dt, Fmax, freq);
